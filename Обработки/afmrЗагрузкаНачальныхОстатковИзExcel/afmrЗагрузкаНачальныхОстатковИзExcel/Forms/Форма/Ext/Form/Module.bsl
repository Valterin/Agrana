...
Процедура ОбработатьТаблицуНаСервере(ИмяРабочейТаблицы)
	...
	Для Каждого СтрокаОбработки  Из ТЗДляОбработки Цикл
		 СтрокаОбработки.НомерВходящегоДокумента  = СтрЗаменить(СтрокаОбработки.НомерВходящегоДокумента,Символы.НПП,"");
		 СтрокаОбработки.НомерДокумента =  СтрЗаменить(СтрокаОбработки.НомерДокумента,Символы.НПП,"");	
	КонецЦикла; 
